...
import { Brain, Clock, Search, Star, Users, Home as HomeIcon, Library, LogOut, User, Settings, Bell } from "lucide-react"
...
export default function ExplorePage() {
  ...
  // Notification logic (optional, demo only)
  ...
  const formatNotificationRelativeTime = (dateString: string) => {
    const date = new Date(dateString)
    const now = new Date()
    const diffInMs = now.getTime() - date.getTime()
                          ...
                          >
                            <div className="flex flex-col gap-1 w-full">
                              ...
                              <span className="text-xs text-muted-foreground">
                                {formatNotificationRelativeTime(notification.time)}
                              </span>
                            </div>
                          </DropdownMenuItem>
                        ))
